...
<style>
    ...
    .cloud1 { top: 15%; left: 50px; }
    .cloud2 { top: 25%; left: 150px; font-size: 2.5em; opacity: 0.6; }
    .cloud3 { top: 35%; left: 250px; font-size: 3.5em; opacity: 0.8; }
    .cloud4 { top: 45%; left: 350px; font-size: 2em; opacity: 0.5; }
    .cloud5 { top: 55%; left: 450px; font-size: 3em; opacity: 0.7; }
    .cloud6 { top: 65%; left: 550px; font-size: 2.2em; opacity: 0.5; }
    .cloud7 { top: 75%; left: 650px; font-size: 3.2em; opacity: 0.9; }
    .cloud8 { top: 20%; left: 750px; font-size: 2.8em; opacity: 0.6; }

    /* Animation */
    .move {
        animation: cloudMove linear infinite;
    }
    .cloud1.move { animation-duration: 60s; }
    .cloud2.move { animation-duration: 75s; }
    .cloud3.move { animation-duration: 90s; }
    .cloud4.move { animation-duration: 120s; }
    .cloud5.move { animation-duration: 80s; }
    .cloud6.move { animation-duration: 100s; }
    .cloud7.move { animation-duration: 110s; }
    .cloud8.move { animation-duration: 130s; }
