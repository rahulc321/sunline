                            ...
                            <div class="d-sm-flex align-items-center mb-3 mb-lg-0 ms-lg-3">
                                <div class="d-inline-flex align-items-center">
                                    <a href="#" class="status-indicator-container ms-1">
                                        <img src="{{ asset('vendor/images/demo/users/face24.jpg') }}" class="w-32px h-32px rounded-pill" alt="">
                                        <span class="status-indicator bg-warning"></span>
                                    </a>
                                    <a href="#" class="status-indicator-container ms-1">
                                        <img src="{{ asset('vendor/images/demo/users/face1.jpg') }}" class="w-32px h-32px rounded-pill" alt="">
                                        <span class="status-indicator bg-success"></span>
                                    </a>
                                    <a href="#" class="status-indicator-container ms-1">
                                        <img src="{{ asset('vendor/images/demo/users/face3.jpg') }}" class="w-32px h-32px rounded-pill" alt="">
                                        <span class="status-indicator bg-danger"></span>
                                    </a>
                                    <a href="#" class="status-indicator-container ms-1">
                                        <img src="{{ asset('vendor/images/demo/users/face5.jpg') }}" class="w-32px h-32px rounded-pill" alt="">
                                        <span class="status-indicator bg-success"></span>
                                    </a>
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{ asset('vendor/images/brands/facebook.svg') }}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{ asset('vendor/images/brands/youtube.svg') }}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{ asset('vendor/images/brands/spotify.svg') }}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{ asset('vendor/images/brands/twitter.svg') }}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{ asset('vendor/images/brands/bing.svg') }}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{ asset('vendor/images/brands/amazon.svg') }}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-block me-3">
                                                            <img src="{{ asset('vendor/images/brands/dribbble.svg') }}" class="rounded-circle" width="36" height="36" alt="">
                                                        </a>
                                                        <div>
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{ asset('vendor/images/demo/users/face15.jpg') }}" class="rounded-circle" width="40" height="40" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{ asset('vendor/images/demo/users/face3.jpg') }}" class="rounded-circle" width="40" height="40" alt="">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{ asset('vendor/images/demo/users/face8.jpg') }}" class="rounded-circle" width="40" height="40" alt="">
                                                        </a>
                                                        <div>
                                ...
                                <div class="card-body pb-0">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="d-sm-flex align-items-sm-start mb-3">
                                                <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                    <img src="{{ asset('vendor/images/demo/flat/1.png') }}" class="flex-shrink-0 rounded" height="100" alt="">
                                            ...
                                            <div class="d-sm-flex align-items-sm-start mb-3">
                                                <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                    <img src="{{ asset('vendor/images/demo/flat/21.png') }}" class="flex-shrink-0 rounded" height="100" alt="">
                                                    <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                                        <i class="ph-play"></i>
                                                    </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="d-sm-flex align-items-sm-start mb-3">
                                                <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                    <img src="{{ asset('vendor/images/demo/flat/12.png') }}" class="flex-shrink-0 rounded" height="100" alt="">
                                                    <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                                        <i class="ph-play"></i>
                                                    </div>
                                            ...
                                            <div class="d-sm-flex align-items-sm-start mb-3">
                                                <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                    <img src="{{ asset('vendor/images/demo/flat/18.png') }}" class="flex-shrink-0 rounded" height="100" alt="">
                                                    <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                                        <i class="ph-play"></i>
                                                    </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{ asset('vendor/images/demo/logos/1.svg') }}" alt="" height="36">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{ asset('vendor/images/demo/logos/2.svg') }}" alt="" height="36">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{ asset('vendor/images/demo/logos/3.svg') }}" alt="" height="36">
                                                        </a>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="d-inline-block me-3">
                                                            <img src="{{ asset('vendor/images/demo/logos/4.svg') }}" alt="" height="36">
                                                        </a>
                                                        <div>
                            ...
                            <div class="card">
                                ...
                                <div class="tab-content card-body">
                                    <div class="tab-pane active fade show" id="messages-tue">
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face10.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-success"></span>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face3.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-danger"></span>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face24.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-danger"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face4.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-danger"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face25.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-success"></span>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="messages-mon">
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face2.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-success"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face7.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-warning"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face18.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-warning"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face14.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-success"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face8.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-success"></span>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="messages-fri">
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face15.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-danger"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face12.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-warning"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face22.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-danger"></span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start">
                                            <div class="status-indicator-container me-3">
                                                <img src="{{ asset('vendor/images/demo/users/face17.jpg') }}" class="rounded-circle" width="40" jeight="40" alt="">
                                                <span class="status-indicator bg-secondary"></span>
                                            </div>
