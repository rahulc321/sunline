...
@section('title', "Lead Source Edit")
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card form_1">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.leadSource.update', [$source->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <!-- Name -->
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('source') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" id="source" name="source" class="form-control"
                                        value="{{ old('source', isset($source) ? $source->source : '') }}" required>
