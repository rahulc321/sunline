        ...
        <div class="collapse d-lg-block my-lg-auto ms-lg-auto" id="page_header">
            <div class="d-sm-flex align-items-center mb-3 mb-lg-0 ms-lg-3">
                <div class="d-inline-flex align-items-center">
                    @can('create_webhook')
                    <a href="{{ route("admin.createWebhook") }}"
                        ...
                        <table class="table table-bordered table-striped table-hover datatable datatable-User">
                            ...
                            <tbody>
                                ...
                                <tr data-entry-id="{{ $value->id }}">
                                    ...
                                    <a href="{{ route('admin.apiLog', $value->id) }}"
                                            class="btn btn-sm btn-outline-info p-1">
                                            <i class="ph-eye"></i>
                                        </a>

                                        @can('edit_webhook')
                                        <a href="{{ route('admin.editWebhook', $value->id) }}"
                                            class="btn btn-sm btn-outline-info p-1">
                                            <i class="ph-pencil"></i>
                                        </a>
                                        @endcan
                                        ...
                                        @can('delete_webhook')
                                        <form action="{{ route('admin.deleteWebhook', $value->id) }}" method="POST"
