...
@section('title', 'Edit Intake Values')
			  ...
			  <div class="col-md-12">
				...
				<div class="card card-primary">
				  <div class="card-header">
					<h3 class="card-title">Edit Intake Values <small>&nbsp;</small></h3>
				  </div>
				  <!-- /.card-header -->
				  <!-- form start -->
				  <form method="POST" action="{{ route('admin.intake-values.update',$intake_values->id) }}" class="col-md-6">
					@csrf
					@method('PUT')
					<div class="card-body">
					  ...
					  <div class="form-group">
						...
						<input name="value" class="form-control" id="value" value="{{old('value',$intake_values->value)}}"/>
						@error('value')
							<div class="error text-danger">{{$message}}</div>
						@enderror
					  </div>
