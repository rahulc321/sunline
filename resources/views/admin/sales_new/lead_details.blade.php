...
<div class="rk-overview-wrapper">
    ...
    <div class="rk-overview-header">
        <h3 class="rk-overview-title">Sales Overview #{{$lead->id}}</h3>
    ...
    <div class="rk-overview-body">
                ...
                <div class="rk-summary-row">
                    ...
                    <div>
                        ...
                        <form method="POST" action="/admin/updateSalesStatus" id="statusForm-{{$lead->id}}">
                            ...
                            <select class="form-select form-select-sm" onchange="document.getElementById('lead-status-{{$lead->id}}').value=this.value; 
                                document.getElementById('statusForm-{{$lead->id}}').submit();">

                                <option value="">Select Status</option>

                                <option value="Installed" {{ $lead->sale_status == 'Installed' ? 'selected' : '' }}>
                                    Installed
                                </option>

                                <option value="Cancelled" {{ $lead->sale_status == 'Cancelled' ? 'selected' : '' }}>
                                    Cancelled
                                </option>
        ...
        <div class="rk-files-card">
            ...
            <div class="rk-files-header">
                ...
                <button id="addFileBtn" class="btn btn-sm btn-outline-primary d-none">
                    + Add Files
                </button>
            ...
            <ul class="rk-attach-list">
                ...
                <li class="rk-attach-item">
                    ...
                    {{-- delete button --}}
                    <a href="javascript:void(0)" class="text-danger delete-lead-image d-none" data-id="{{ $file->id }}"
