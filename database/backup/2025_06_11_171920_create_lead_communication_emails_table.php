...
return new class extends Migration
{
    ...
    {
        Schema::create('lead_communication_emails', function (Blueprint $table) {
            $table->increments('id');
			...
			$table->foreign('user_id')
      			  ...
      			  ->onDelete('CASCADE')
      			  ->onUpdate('CASCADE');			
			$table->unsignedInteger("email_status_id")->nullable();
			$table->foreign('email_status_id')
      			  ->references('id')->on('email_status')
      			  ->onDelete('set null');
    ...
    {
        Schema::dropIfExists('lead_communication_emails');
    }
};
